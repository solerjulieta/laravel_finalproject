...
<section class="container admin">
    ...
    <h1 class="mt-3">Eliminar: "{{ $entrada->titulo }}"</h1>
    <p>Estás por eliminar la siguiente entrada. ¿Estás seguro/a que querés confirmar la acción?</p>
    ...
    <form id="form-eliminar" action="{{ route('admin.entradas.eliminar', ['id' => $entrada->entrada_id]) }}" method="post">
    @csrf    
