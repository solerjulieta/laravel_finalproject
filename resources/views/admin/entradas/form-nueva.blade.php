...
@section('title', 'Agregar una nueva entrada')
...
<section class="container admin">
    ...
    <h1 class="mt-3">Agregar una nueva entrada</h1>
    <p>Completá los siguientes datos del formulario para publicar una nueva entrada.</p>
    @if($errors->any())
    ...
    @endif
    <form action="{{route('admin.entradas.publicar')}}" method="post" enctype="multipart/form-data" class="row form-admin">
        @csrf
        ...
        <fieldset class="mb-3 col-lg-10">
            ...
            <div class="form-check form-check-inline">
                <input 
                    ...
                    @checked(old('etiquetas') !== null && in_array($etiqueta->etiqueta_id, old('etiquetas')))
                >
